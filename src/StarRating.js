...
export default function StarRating({
  ...
  function handleRating(rating) {
    setRating(rating);
    if (onSetRating) onSetRating(rating); // incase of onSetRating is not mentioned from user. it is important becuase if itwas not guarded by condition then if use dont mention setter func. then console will throw error for onSetRating undefined.
  }
